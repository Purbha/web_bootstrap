...
<div class="container-fluid bg-3 text-center">
	...
	<div class="row">
    	<div class="col-sm-4">
            <img src="img/Col1.jpg" alt="Gambar 1" width="350" height="300">
            <p class="text-justify">
        ...
        <div class="col-sm-4"> 
            <img src="img/Col2.jpg" alt="Gambar 2" width="350" height="300">
            <p class="text-justify">
        ...
        <div class="col-sm-4"> 
            <img src="img/Col3.jpg" alt="Gambar 3" width="350" height="300">
            <p class="text-justify">
